...
// these functions are defined in the startup file if using a Keil.
// if using Code Composer Studio, or this github project the above statement is not true.
// There is an complementary OS_DisableInterrupts and OS_EnableInterrupts defined in this project
